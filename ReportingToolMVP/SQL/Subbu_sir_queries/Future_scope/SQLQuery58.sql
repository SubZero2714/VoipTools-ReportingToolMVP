USE [3CX Exporter]
GO
/****** Object:  StoredProcedure [dbo].[sp_rpt__extension_statistics_cdr_united]    Script Date: 09-02-2026 07:18:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE or ALTER  PROCEDURE [dbo].[sp_rpt__extension_statistics_cdr_united]
(
...
BEGIN
    SET NOCOUNT ON;
	declare @observers  VARCHAR(MAX) = '';
	declare  @wait_interval       TIME(0)='00:00:00';
    ;WITH cdr_stats AS
    (
        SELECT *
